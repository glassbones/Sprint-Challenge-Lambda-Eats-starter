...
**useRouteMatch lets you access to the match property without a <Route> component. Without this hook you would have to do a lot more work to get to the match object.**

2. How would you explain form validation to someone who has never programmed before?

**Form validation is like the input police. When you enter your input to form validation (the form police) looks over a bunch of rules and if you are breaking any of the designated rules with your inputs you can recieve a warning (a warning message) or you might not be allowed to submit your form.**

3. In 1-2 sentences, define end to end testing. 

**End to end testing tests your entire application to see if it performs as expected. For instance if you had 50 inputs linked to one submit button and didn't want the user to be able to submit the application without valid data in each input you would want to use end to end test so that you can ensure each individual input is working as expected.**
